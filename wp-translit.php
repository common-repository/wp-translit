...
class WP_TRANSLIT
{
	...
	function __construct() {
		...
		add_filter('admin_notices', array (&$this, 'admin_upgrade_notice'));
	...
	{
		printf(
			'<div class="notice notice-error"><p><strong>This plugin has been deprecated</strong>, please switch to <a href="%s">Serbian Latinisation plugin</a></p></div>',
			admin_url('plugin-install.php?s=serbian+latinisation&tab=search&type=term')
		);
	}
